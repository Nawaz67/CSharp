...
namespace HospitalManagementPL
{
    public class PatientPL
    {
        ...
        public void AddPatient()
        {
            ...
            Patient patient = new Patient(PatientId,PatientName,PatientEmail,PatientPassword,PatientType);
        ...
        public void GetAllPatient()
        {
            ...
            Console.WriteLine("--Patient Id--------------Patient Name----------Patient Email-------------Patient Password---------Patient Type");
            Console.ForegroundColor = ConsoleColor.White;
            PatientBLL patientBLL = new PatientBLL();
        ...
        public void Search()
        {
            ...
            foreach (var item in patientBLLList)
            {
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Green;
                    Console.WriteLine("-------------Patient Type Details By Id-----------");
                    Console.ForegroundColor = ConsoleColor.Yellow;
                    Console.WriteLine("--Patient Id---------------Patient Type");
                    Console.ForegroundColor = ConsoleColor.White;
                    Console.WriteLine(item.PatientId + "\t \t \t "+ item.PatientType);
                    Console.ForegroundColor = ConsoleColor.Yellow;
                    Console.WriteLine("-------------------------------------------------------------");
                    Console.ForegroundColor = ConsoleColor.White;
                    PatientMenu();
